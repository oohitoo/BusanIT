		...
		<tr>
			<td align="center" bgcolor="#FFFFCC">
				<table width="95%" bgcolor="#FFFF99" border="1">
					...
					%>
					<tr>
						<td colspan="5">주문하신 물품이 없습니다.</td>
					</tr>
					<%
						} else {
							for(int i = 0; i < vlist.size(); ++i){
								OrderBean order = vlist.get(i);
								int productNo= order.getNo();
								
								productBean pbean = pMgr.getproduct(productNo);
								%>
								<tr align="center">
									<td><%= order.getNo() %></td>
									<td><a href="javascript:productDetail('<%=order.getNo()%>')"><%= pbean.getName() %></a></td>
									...
									<td>
										<%
											switch(order.getState()){
												...
												case "4": out.print("베송준비"); break;
												case "5": out.print("배송중"); break;
												case "6": out.print("배송완료"); break;
											}
										%>
									</td>
								</tr>
